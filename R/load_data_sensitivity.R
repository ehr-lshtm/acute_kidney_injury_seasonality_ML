...
aki_cohort_chapter3 <-
  fread(file.path(rawdata_temp_files_path, "aki_cohort_chapter3_sensitivity.txt"))          

aki_cohort_chapter2 <-
  fread(file.path(rawdata_temp_files_path, "aki_cohort_chapter2_sensitivity.txt"))          

ind.coord <-
  fread(file.path(rawdata_temp_files_path, "ind_coord_chapter3_600_sensitivity.txt"))

res.mca <-
  readRDS("res_mca_chapter3_sensitivity.RData")                                                #### change to chapters or medcode up the hierarchy
