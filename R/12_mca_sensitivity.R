...
aki_cohort_chapter3 <- aki_cohort %>%
  ...
  write_tsv(file.path(rawdata_temp_files_path, "aki_cohort_chapter3_sensitivity.txt"))  
...
aki_cohort_chapter2 <- aki_cohort %>%
  ...
  write_tsv(file.path(rawdata_temp_files_path, "aki_cohort_chapter2_sensitivity.txt"))  
...
saveRDS(res.mca, file="res_mca_chapter3_sensitivity.RData")                                 
...
ind.coord %>% 
  write_tsv(file.path(rawdata_temp_files_path, "ind_coord_chapter3_600_sensitivity.txt"))          